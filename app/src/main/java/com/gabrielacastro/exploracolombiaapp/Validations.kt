...
//retorne un true si es valido y un false si no
//retorne una cadena de texto q diga por que no es valido
...
fun validatePassword(password:String): Pair<Boolean, String>{
    return when{
        ...
        password.length<7->Pair(false, "La contraseña debe contener al menos 7 caracteres")
